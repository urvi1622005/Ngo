export default function Component() {
  return (
    ...
    <div className="flex items-center justify-center min-h-screen">
      {/* Left Section with Brown Background */}
      <div className="bg-[#8B5E51] p-6 mr-8  w-1/2 md:w-1/3 rounded-3xl flex flex-col items-center space-y-6">
        <div className="rounded-3xl overflow-hidden w-64 h-64 mx-auto md:mx-0 border-0 border-white shadow-lg transform transition-transform duration-300 hover:scale-110">
          <img
        ...
        <h1 className="text-white text-5xl font-bold leading-tight text-center">
          Recent<br />Cause
        </h1>
      ...
      <div className="w-full md:w-1/3 p-8 space-y-6 flex flex-col items-center bg-gray-100">
        {/* Cause Card 1 */}
        <div className="bg-white rounded-3xl p-6 shadow-lg transition-transform duration-300 transform hover:scale-105">
